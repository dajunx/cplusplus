...
namespace sigslot {
    ...
    {
    public:
        _connection_base0(): m_disable(false) {};
        bool is_available() {return !m_disable;};
    ...
    {
    public:
        _connection_base1(): m_disable(false) {};
        bool is_available() {return !m_disable;};
        void disable(){m_disable = true;};
    ...
    {
    public:
        _connection_base2(): m_disable(false) {};
        bool is_available() {return !m_disable;};
        void disable(){m_disable = true;};
    ...
    {
    public:
        _connection_base3(): m_disable(false) {};
        bool is_available() {return !m_disable;};
        void disable(){m_disable = true;};
    ...
    {
    public:
        _connection_base4(): m_disable(false) {};
        bool is_available() {return !m_disable;};
        void disable(){m_disable = true;};
    ...
    {
    public:
        _connection_base5(): m_disable(false) {};
        bool is_available() {return !m_disable;};
        void disable(){m_disable = true;};
    ...
    {
    public:
        _connection_base6(): m_disable(false) {};
        bool is_available() {return !m_disable;};
        void disable(){m_disable = true;};
    ...
    {
    public:
        _connection_base7(): m_disable(false) {};
        bool is_available() {return !m_disable;};
        void disable(){m_disable = true;};
    ...
    {
    public:
        _connection_base8(): m_disable(false) {};
        bool is_available() {return !m_disable;};
        void disable(){m_disable = true;};
    ...
    public:
        ...
        ~_signal_base0()
        {
            persist_disconnect_all();
        }

        bool is_empty()
        {
            lock_block<mt_policy> lock(this);
            typename connections_list::iterator itNext, it = m_connected_slots.begin();
            ...
            bool connected(has_slots<mt_policy>* pclass)
        {
            ...
            while(it != itEnd)
            {
                itNext = it;
                ++itNext;
                if ((*it)->getdest() == pclass && (*it)->available())
                    return true;
                it = itNext;
            }
            return false;
        ...
        void disconnect(has_slots<mt_policy>* pclass)
        {
            ...
            while(it != itEnd)
            {
                if((*it)->getdest() == pclass && (*it)->is_available())
                {
                    (*it)->disable();
