...
int main()
{
  ...
  std::pair<age_map0::iterator, age_map0::iterator> it_range = i.equal_range(40);
  if (it_range.first != i.end())
  {
    ...
    {
      it_child->age;
      std::cout<<"id:"<<it_child->id<<", name:"<<it_child->name<<", age:"<<it_child->age<<std::endl;
    }
  }
  //print_out_by<id>(es);
  std::cout<<std::endl;
  ...
  {
    std::cout<<"id:"<<id_map_begin->id<<", name:"<<id_map_begin->name<<", age:"<<id_map_begin->age<<std::endl;
  }
  std::cout<<std::endl;
  ...
  {
    std::cout<<"id:"<<age_map_begin->id<<", name:"<<age_map_begin->name<<", age:"<<age_map_begin->age<<std::endl;
  }
  std::cout<<std::endl;
